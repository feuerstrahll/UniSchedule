...
class TimeSchedulerTable extends StatefulWidget {
  ...
  /// [scrollColor] is color of horizontal and vertical scrolls. Default value is Colors.deepOrange.withValues(alpha: 0.5)
  final Color? scrollColor;

  /// [scrollTrackingColor] is tracking color of the scroll. Default value is Colors.deepOrange.withValues(alpha: 0.1)
